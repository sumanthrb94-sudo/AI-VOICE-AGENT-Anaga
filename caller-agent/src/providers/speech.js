 ...
 */
// Splitting lives in shared/speech-split.js — the API needs the identical rule
// (api/anaga/turn.js renders the first phrase server-side), and two copies of a
// splitter drift. Re-exported so every existing importer of this module is
// unaffected.
export { splitForSpeech, isRunt } from '../../../shared/speech-split.js';
